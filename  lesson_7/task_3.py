...
class Square:
    ...
    def __sub__(self, other):
        if  self.count - other.count > 0:
            sub = f'Вычетание: {self.count - other.count}'
        else:
            sub = 'вычетание не возмжно'
        return sub
    ...
    def make_order(self, line):
        tabl = ""
        for i in range(int(self.count // line)):
            tabl += '*' * line + '\n'
        tabl += '*' * (self.count - ((self.count // line)*line))
        return tabl


sq_1 = Square(39)
sq_2 = Square(32)
print(sq_1.__add__(sq_2))
print(sq_1.__sub__(sq_2))
print(sq_1.__mul__(sq_2))
print(sq_1.__truediv__(sq_2))
print(sq_2.make_order(5))
